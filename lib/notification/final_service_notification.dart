...
import 'dart:math' show Random; // For generating random numbers (show only Random class)
...
class FirebaseNotification {
  ...
  static Future<void> initializeLocalNotifications() async {
    ...
    const InitializationSettings initializationSettings =
      ...
      android: AndroidInitializationSettings('@mipmap/ic_launcher'), // Android icon
